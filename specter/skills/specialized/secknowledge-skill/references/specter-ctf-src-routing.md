# Specter CTF/SRC Routing Guide

This reference connects `secknowledge-skill` to Specter's CTF and SRC workflows.
...
Keep Specter's existing specialist skills in the loop:
...
2. If it is a narrow CTF trick, route to the matching Specter CTF skill and use this skill only for broader vulnerability families or evidence discipline.
