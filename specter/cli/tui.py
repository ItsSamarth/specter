...
from specter.i18n import _, init_i18n
...
def build_dashboard(config, state: TuiState) -> Group:
    """Build the first-screen Specter TUI dashboard."""
    ...
    title = Text(" Specter TUI", style=f"bold {C_ACCENT}")
...
def _cmd_report(session: dict[str, Any], args: str) -> None:
    ...
    from specter.cli.main import _generate_report_for_target
...
def _default_launcher(draft: TuiTaskDraft) -> None:
    from specter.cli import main as cli_main
