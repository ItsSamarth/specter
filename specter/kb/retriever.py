"""Specter Knowledge Retriever — retrieve relevant knowledge for the agent.
...
class _ChromaRetriever:
    ...
    def _build(self) -> None:  # pragma: no cover - requires chromadb installed
        ...
        self._collection = client.get_or_create_collection("specter_kb")
