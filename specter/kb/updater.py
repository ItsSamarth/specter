"""Specter Knowledge Updater — update and seed the knowledge base."""
    ...
    techniques = [
        {
            ...
            "description": "Methods to build SQL injection payloads that bypass WAFs",
        ...
        },
        {
            ...
            "description": "Building command-execution payloads that bypass PHP WAFs",
            ...
            "bypass_methods": [
                ...
                "Reverse string: $f=strrev('metsys');$f('id');",
            ],
        },
        {
            "id": "xss-bypass",
            "title": "XSS bypass techniques",
            "description": "Building payloads that bypass WAF/XSS filters",
    ...
    tools = [
        ...
        },
        {
            ...
            "workflow": [
                ...
                "Analyze parameters and endpoints in requests",
