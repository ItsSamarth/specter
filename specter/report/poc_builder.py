"""Specter PoC Builder — auto-generate runnable PoC scripts for findings."""
...
from specter.report.verifier import PoCGenerator
...
Target: {{ target }}
Generated by Specter on {{ generated_at }}
