"""Specter configuration schema — Pydantic models for type-safe config."""
...
class ReconConfig(BaseModel):
    ...
    keys in ~/.specter/config.yaml (gitignored), not in source.
    """
...
class SessionConfig(BaseModel):
    ...
    output_dir: Path = Field(default=Path("./specter-output"), description="Output directory")
