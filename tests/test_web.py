...
class TestWebServices:
    def test_constraint_audit_service_aggregates_events(self, monkeypatch, tmp_path):
        ...
        from specter.web.services.constraint_audit_service import get_constraint_audit
        ...
        monkeypatch.setattr("specter.web.services.constraint_audit_service.TARGETS_DIR", tmp_path)
    ...
    def test_web_config_service(self):
        from specter.web.services.config_service import get_public_config
    ...
    def test_web_config_service_updates_subset(self, monkeypatch, tmp_path):
        ...
        from specter.web.schemas import ConfigUpdateRequest
    ...
    def test_web_target_service_lists_targets(self, monkeypatch, tmp_path):
        import specter.target_state.store as store_mod
        import specter.web.services.target_service as target_service
    ...
    def test_web_target_service_preview_and_diff(self, monkeypatch, tmp_path):
        import specter.target_state.store as store_mod
        import specter.web.services.target_service as target_service
        from specter.agent.context import SessionState, TaskConstraints, VulnerabilityFinding
    ...
    def test_web_report_service_generates_target_report(self, monkeypatch, tmp_path):
        import specter.target_state.store as store_mod
        import specter.web.services.report_service as report_service
        from specter.agent.context import SessionState, VulnerabilityFinding
    ...
    async def test_web_task_manager_event_flow(self):
        from specter.web.schemas import TaskCreateRequest
        from specter.web.task_manager import WebTaskManager
    ...
    def test_web_task_prompt_includes_explicit_constraints(self):
        from specter.web.schemas import TaskCreateRequest, TaskOptions
        from specter.web.services.task_service import _build_prompt_v2
    ...
    def test_web_task_options_reject_invalid_only_port(self):
        ...
        from specter.web.schemas import TaskOptions
    ...
    def test_web_task_manager_persists_and_restores_tasks(self, monkeypatch, tmp_path):
        import specter.web.task_manager as task_manager_mod
        from specter.web.schemas import TaskCreateRequest
    ...
    async def test_web_task_service_restore_summary_flow(self, monkeypatch):
        import specter.web.services.task_service as task_service
        from specter.agent.context import SessionState
        from specter.config.schema import SpecterConfig
        from specter.web.schemas import TaskCreateRequest
        from specter.web.task_manager import WebTaskManager
    ...
    async def test_orchestrator_shared_run_flow(self, monkeypatch):
        import specter.orchestrator as orchestrator
        from specter.agent.context import SessionState
    ...
    def test_web_stream_encode(self):
        from specter.web.schemas import TaskEvent
        from specter.web.stream import encode_sse
...
class TestWebApp:
    def test_constraint_audit_route_works_without_fastapi(self, monkeypatch):
        import specter.web.app as web_app
    ...
    def test_frontend_toc_navigation_hides_advanced_console(self):
        ...
        assert "Unable to reach the Specter backend API" in api_source
    ...
    def test_static_fallback_is_toc_shell(self):
        ...
        source = (root / "specter" / "web" / "static" / "index.html").read_text(
            encoding="utf-8"
        )
