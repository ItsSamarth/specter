"""Specter MCP Module Tests — registry.py + router.py + lifecycle.py"""
...
class TestMCPRegistry:
    ...
    def test_register_server(self):
        from specter.mcp.registry import MCPRegistry
...
class TestMCPLifecycleManager:
    ...
    def test_init(self):
        ...
        manager = MCPLifecycleManager(SpecterConfig())
    ...
    def test_sse_placeholder_records_invalid_url_error(self):
        from specter.config.schema import MCPServerConfig, MCPTransportConfig, SpecterConfig
        from specter.mcp.lifecycle import MCPLifecycleManager
...
class TestStructuredToolResults:
    ...
    async def test_tool_call_manager_preserves_structured_content(self):
        from specter.agent.tool_call_manager import handle_tool_calls_with_results
